...
输出：cp 到 /Users/jdy/Documents/obsidian/60_Output/公众号/<YYYYMM>/illustrations/<topic-slug>/NN-<slug>.png
确认：ls -la 报告文件大小'
```
...
- 路径：`60_Output/公众号/<YYYYMM>/illustrations/<topic-slug>/NN-<slug>.png`
- 文章内引用：相对路径 `./illustrations/<topic-slug>/NN-<slug>.png`
- 紧跟对应段落后，不堆到文末
- 文件名冲突：`-v2` 后缀
- 检查：路径可解析、内容对应场景、无隐私/账户/地址/logo/水印
...
输出：cp 到 /Users/jdy/Documents/obsidian/60_Output/公众号/<YYYYMM>/attachments/cover.png
（如已存在用 cover-v2.png）
确认：ls -la 报告文件大小'
```
